...
- editor de mapas
- **[pedido 2026-05-16] editor de mapa — modo "edição limpa"**: ao entrar no editor de mapa, esconder/desativar tudo que não é edição — interações com avatares (click/right-click/menu de contexto), áudio espacial e sons, balões de vídeo/fala, joystick mobile, etc. O editor deve ser uma tela focada só em mover/adicionar/remover mobília. Sair do editor restaura tudo.
- **[pedido 2026-05-16] editor de mapa — adicionar itens DENTRO das salas**: hoje a adição de itens não funciona/é bloqueada dentro das salas (zonas de reunião/copa/etc). Precisa permitir posicionar mobília nova em qualquer lugar, inclusive dentro das salas.
